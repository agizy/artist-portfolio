(function () {
    ...
    const translations = {
        ja: {
            ...
            about_label: 'プロフィール',
            about_title: '写真家について',
            about_bio_1: '東京を拠点に、光、形、人間の感情の交差点を探求して10年以上。風景、ポートレート、ストリートフォトグラフィーを手がけ、より深い真実を映し出す静かな瞬間を常に求めています。',
            ...
            contact_desc: '撮影依頼、コラボレーション、エディトリアルの案件を承ります。東京拠点、全世界対応。',
            contact_email: 'メール',
            contact_phone: '電話',
        ...
        en: {
            ...
            about_bio_1: 'Based in Tokyo, I have spent over a decade exploring the intersection of light, form, and human emotion. My work spans landscape, portrait, and street photography, always seeking the quiet moments that reveal deeper truths.',
            ...
            contact_desc: 'Available for commissions, collaborations, and editorial assignments. Based in Tokyo, available worldwide.',
            contact_email: 'Email',
            contact_phone: 'Phone',
            contact_instagram: 'Instagram',
            contact_location: 'Location',
            contact_tokyo: 'Tokyo, Japan',
        ...
        fr: {
            ...
            about_bio_1: 'Basé à Tokyo, je passe depuis plus d\'une décennie à explorer l\'intersection de la lumière, de la forme et de l\'émotion humaine. Mon travail couvre le paysage, le portrait et la photographie de rue.',
            ...
            contact_desc: 'Disponible pour des commandes, collaborations et missions éditoriales. Basé à Tokyo, disponible dans le monde entier.',
            contact_email: 'E-mail',
            contact_phone: 'Téléphone',
            contact_instagram: 'Instagram',
            contact_location: 'Localisation',
            contact_tokyo: 'Tokyo, Japon',
